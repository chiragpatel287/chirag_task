                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <h4 class="m-b-30 m-t-0">Blog Add</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <form method="POST" action="{{route('blogs.store')}}" id="blogsForm" enctype="multipart/form-data" onsubmit="return validation()" autocomplete="off">
                                        @method('POST')
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" autocomplete="off" value="" class="form-control" id="title" placeholder="Title">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" autocomplete="off" value="{{old('description')}}" class="form-control editor1" id="description" placeholder="Description"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category[]" class="form-control" id="category" multiple>
                                                ...
                                                <option value="{{$rwData->id}}">{{$rwData->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="blog_image">Blog Image <span style="color:red" class="required-error">&nbsp;*</span></label>
                                        ...
                                        <button type="submit" id="submitBtn1" class="btn btn-primary waves-effect waves-light">Submit</button>
    ...
    function validation() {
        ...
        if (blog_image != "") {
            if (!(regex.test(blog_image))) {
                ...
                $('#images_error').html("Please select Blog image");
                temp++;
        }
